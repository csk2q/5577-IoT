...
('ESP32-VS-006', 4, 'vital_signs', 'active', '1.2.3'),
('ESP32-VS-007', 5, 'vital_signs', 'active', '1.2.3');
...
-- Patient 1 (Robert Anderson) - Normal vitals
...
-- Patient 2 (Mary Thompson) - Warning condition
INSERT INTO sensor_readings (sensor_id, patient_id, heart_rate, blood_oxygen_level, temperature, reading_quality) VALUES
...
-- Patient 3 (James Wilson) - Critical condition
INSERT INTO sensor_readings (sensor_id, patient_id, heart_rate, blood_oxygen_level, temperature, reading_quality) VALUES
...
-- Patient 4 (Linda Jackson) - Normal vitals
INSERT INTO sensor_readings (sensor_id, patient_id, heart_rate, blood_oxygen_level, temperature, reading_quality) VALUES
(4, 4, 65, 98.7, 36.6, 'good'),
(4, 4, 67, 98.8, 36.7, 'good'),
(4, 4, 66, 98.6, 36.6, 'good'),
(4, 4, 68, 98.9, 36.7, 'good'),
(4, 4, 64, 98.7, 36.6, 'good');

-- Patient 5 (William White) - Elevated heart rate
INSERT INTO sensor_readings (sensor_id, patient_id, heart_rate, blood_oxygen_level, temperature, reading_quality) VALUES
(5, 5, 73, 97.5, 37.0, 'good'),
(5, 5, 75, 97.6, 37.1, 'good'),
(5, 5, 74, 97.4, 37.0, 'good'),
(5, 5, 72, 97.7, 37.0, 'good'),
(5, 5, 76, 97.5, 37.1, 'good');

-- ============================================================================
-- SAMPLE ALERTS - Create some alerts for testing
-- ============================================================================

-- Acknowledged alert for Patient 3 (James Wilson - Critical)
...
(2, 'view_patient', 'patient', '3', '192.168.1.101', '{"action": "viewed patient details"}'),
(2, 'acknowledge_alert', 'alert', '1', '192.168.1.101', '{"alert_type": "heart_rate_high"}'),
(5, 'create_patient', 'patient', '4', '192.168.1.105', '{"action": "created new patient record"}');
